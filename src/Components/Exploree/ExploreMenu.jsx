  ...
  return (
    ...
    <p className='text-sm w-4/4 lg:w-1/2 text-slate-500 pt-5'>choose from a delivery menu featuring a delectable array of dishes. 
        Our mission is your satify your cravings and elevate your dining
         ...
         <div className='flex  justify-between text-center gap-3 items-center pt-6 ' id='circle'>
            {
                Foods.map((food)=>{
                    return(
                        <div className='cursor-pointer lg:cursor-pointer' >
                            ...
                            <img id='exp' className={category === food.menu_name ? 'circle' : ''} src={food.menu_image} alt='name'/>
                            <p className=' mt-3 lg:mt-2 text-sm text-slate-500  lg:text-xl'>{food.menu_name}</p>
                           </div>
                        </div>
